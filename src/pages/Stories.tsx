...
export default function Stories() {
  ...
  return (
    <div style={{ minHeight: '70vh', background: 'var(--cream)' }}>
      {/* Header */}
      <div style={{ background: 'linear-gradient(135deg, var(--cream-dark) 0%, var(--gold-pale) 100%)', padding: '4rem 1.25rem 3rem', textAlign: 'center', borderBottom: '2px solid var(--cream-border)' }}>
